...
When reporting a bug, please include a minimal reproducible example, the expected result, the observed result, and your R session information.

## Pull requests

Pull requests are welcome. Before submitting a pull request, please open an issue to discuss substantial changes.
